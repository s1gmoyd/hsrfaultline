<script>
  import { desk, blueTeam, orangeTeam, blueTeamLogo, orangeTeamLogo, matchInfo, matchScores, blueTeamPlayersBoolList, orangeTeamPlayersBoolList } from '../rocsStore'
...
<div id="container">
  ...
  <div class="background analysts"></div>
  ...
  <div class="analyst one name">{$desk && $desk[0] ? $desk[0].name.toUpperCase() : "NAME HERE"}</div>
  <div class="analyst one twitter">@{$desk && $desk[0] ? $desk[0].twitter.toUpperCase() : "TWITTER HERE"}</div>

  <div class="analyst two name">{$desk && $desk[1] ? $desk[1].name.toUpperCase() : "NAME HERE"}</div>
  <div class="analyst two twitter">@{$desk && $desk[1] ? $desk[1].twitter.toUpperCase() : "TWITTER HERE"}</div>

  <div class="analyst three name">{$desk && $desk[2] ? $desk[2].name.toUpperCase() : "NAME HERE"}</div>
  <div class="analyst three twitter">@{$desk && $desk[2] ? $desk[2].twitter.toUpperCase() : "TWITTER HERE"}</div>
</div>
...
<style>
  ...
  .background.analysts {
    background-image: url('/analysts-base.png');
  }

  .analyst.name, .analyst.twitter {
    width: 452px;
    height: 35px;
    text-align: center;
    line-height: 40px;
